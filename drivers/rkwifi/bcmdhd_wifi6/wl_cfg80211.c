...
#ifdef CONFIG_DRIVERS_HDF_WIFI
			HdfWifiEventMgmtTxStatus(GetHdfNetDeviceByLinuxInf(dev), buf, len, true);
#endif
...
#ifdef CONFIG_DRIVERS_HDF_WIFI
			HdfWifiEventMgmtTxStatus(GetHdfNetDeviceByLinuxInf(dev), buf, len, ack);
#endif
			goto exit;
		}
#endif /* WL_CLIENT_SAE */
...
#ifdef CONFIG_DRIVERS_HDF_WIFI
		HdfWifiEventRxMgmt(GetHdfNetDeviceByLinuxInf(ndev), freq, 0, mgmt_frame, len);
#endif
...
#ifdef CONFIG_DRIVERS_HDF_WIFI
		HdfWifiEventRxMgmt(GetHdfNetDeviceByLinuxInf(ndev), freq, rssi, mgmt_frame, len);
#endif
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 12, 0))
		cfg80211_rx_mgmt(cfgdev, freq, 0,  mgmt_frame, len, 0, GFP_ATOMIC);
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 4, 0))
...
#ifdef CONFIG_DRIVERS_HDF_WIFI
	HdfWifiEventRxMgmt(GetHdfNetDeviceByLinuxInf(ndev), freq, 0, mgmt_frame, mgmt_frame_len);
#endif
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 12, 0))
...
#ifdef CONFIG_DRIVERS_HDF_WIFI
			HdfWifiEventRxMgmt(GetHdfNetDeviceByLinuxInf(ndev), cfg->tdls_mgmt_freq, 0, 
...
#ifdef CONFIG_DRIVERS_HDF_WIFI
	HdfWifiEventCsaChannelSwitch(GetHdfNetDeviceByLinuxInf(dev), freq);
#endif
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION (3, 5, 0) && (LINUX_VERSION_CODE <= (3, 7, 0)))
	freq = chan_info.freq;
